...
volatile long rightWheelCounter = 0;
volatile long leftWheelCounter = 0;
double CmPerPulse = 0.5;
bool isFinished;
...
// ULTRASONIC SENSOR SETUP
  ...
  // attachInterrupt(digitalPinToInterrupt(SENSOR_R1), rightWheelCounter, CHANGE);
  // attachInterrupt(digitalPinToInterrupt(SENSOR_R2), leftWheelCounter, CHANGE);
}
...
void lineFollow()
{
  if (allBlack())
  {
    ...
    // idle()
    // int distance = 1;
    // int targetPulses = rightWheelCounter + distance / CmPerPulse;

    // moveForward(200,200);

    // while (rightWheelCounter < targetPulses)
    // {
    //   Serial.println();
    //   // delay(200);
    // }
...
// void avoidObstacle()
// {
//   // Serial.print(Signal_R1);
//   // Serial.print(Signal_R2);
//   if (distance < 16)
//   {
